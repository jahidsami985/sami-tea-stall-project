                ...
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="text-center md:text-left flex-1">
                      ...
                      >
                        Welcome to Sami's Tea Stall – where tradition meets taste. 
                ...
                {activeSection === 'heritage' && (
                  ...
                  >
                    ...
                    <div className="space-y-4" style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
                      <p>
                        Born from a simple passion for the perfect cup of chai, Sami's Tea Stall 
                  ...
                  >
                    ...
                    <div className="space-y-4" style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
                      ...
                      <p>
                        ...
                        of Sami's Tea to every corner of Bangladesh. But more than growth, we 
