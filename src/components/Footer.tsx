  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <span style={{ color: 'var(--text-secondary)' }} className="text-sm">hello@samisteastall.com</span>
              </li>
            </ul>
          </div>
        ...
        >
          <p>© {new Date().getFullYear()} Sami's Tea Stall. All rights reserved.</p>
        ...
        <div className="text-center mt-4 pt-4 border-t" style={{ borderColor: 'var(--border)' }}>
          <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
            Developed by <span className="font-semibold" style={{ color: 'var(--accent)' }}>Jahid</span> © {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
