...
if (adminExists.count === 0) {
  // Default admin: username "admin", password "sami123"
  // In production, use environment variables for credentials
  const defaultUsername = "admin";
  const defaultPassword = process.env.ADMIN_PASSWORD || "sami123";
...
async function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    ...
    console.log(`Default admin credentials: username="admin", password="sami123"`);
